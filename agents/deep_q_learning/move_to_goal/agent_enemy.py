...
DEFAULT_CONFIG = Path(SCRIPT_DIR.parent, "configurations", "enemy_test.json")
...
class AgentConfig(BaseConfig):
    ...
    def __init__(self, config_file: Path):
        ...
        self.enemy_reward = self.config_dict["enemy_reward"]
        self.enemy_initial_pos = self.config_dict["enemy_initial_pos"]


def main():
    parser = argparse.ArgumentParser(description="Deep Q Learning agent that plays the "
                                                 "MoveToGoal enemy environment.")
    ...
    test_game = MoveToGoalEnemy(board_x=experiment_config.board_size[0],
                                board_y=experiment_config.board_size[1],
                                goal_reward=experiment_config.goal_reward,
                                enemy_reward=experiment_config.enemy_reward,
